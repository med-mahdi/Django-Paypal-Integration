...
SECRET_KEY = 'django-insecure-6gn^695koxw3_au8p@k^wznn(vfpq&1^(q434nsm%0#v6td02)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["https://web-production-b045.up.railway.app"]
...
INSTALLED_APPS = [
    ...
    # my secondary Django App
    'paypal_integration',
    # Paypal Apps Integration
    'paypal.standard.ipn',
]
...
PAYPAL_RECEIVER_EMAIL = 'sb-ac1jf26227955@business.example.com'
